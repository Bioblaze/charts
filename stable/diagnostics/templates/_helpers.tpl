...
{{ include "diagnostics.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
*/}}
{{- define "diagnostics.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "diagnostics.fullname" .) .Values.serviceAccount.name }}
{{- else }}
